...
CREATE TABLE IF NOT EXISTS `article` (
  ...
  PRIMARY KEY (`no`),
  KEY `writer` (`writer`),
  CONSTRAINT `article_ibfk_1` FOREIGN KEY (`writer`) REFERENCES `user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=381 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 테이블 데이터 jboard.article:~3 rows (대략적) 내보내기
DELETE FROM `article`;
INSERT INTO `article` (`no`, `cate`, `title`, `content`, `comment`, `file`, `hit`, `writer`, `regip`, `rdate`) VALUES
	(378, 'free', 'aaa', 'bbbb', 0, 0, 0, 'qwer1234', NULL, '2024-09-23 10:36:59'),
	(379, 'free', 'bbb', 'ccc', 0, 0, 0, 'qwer1234', '0:0:0:0:0:0:0:1', '2024-09-23 10:39:06'),
	(380, 'free', 'wefasfe', 'faewfawf', 0, 0, 0, 'qwer1234', '0:0:0:0:0:0:0:1', '2024-09-23 12:44:19');
...
CREATE TABLE IF NOT EXISTS `comment` (
  ...
  KEY `writer` (`writer`),
  KEY `parent` (`parent`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`writer`) REFERENCES `user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`parent`) REFERENCES `article` (`no`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 테이블 데이터 jboard.comment:~0 rows (대략적) 내보내기
DELETE FROM `comment`;
...
CREATE TABLE IF NOT EXISTS `file` (
  ...
  PRIMARY KEY (`fno`),
  KEY `ano` (`ano`),
  CONSTRAINT `file_ibfk_1` FOREIGN KEY (`ano`) REFERENCES `article` (`no`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- 테이블 데이터 jboard.user:~1 rows (대략적) 내보내기
DELETE FROM `user`;
INSERT INTO `user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `role`, `zip`, `addr1`, `addr2`, `regip`, `regDate`, `leaveDate`) VALUES
	('qwer1234', '$2a$10$lYu57Qud8feudHJ.oJV0Ue8t80oLTnL2sK8DGVKYF.QnbqSTkVEXi', '강중원', '하소로', 'noily4748@gmail.com', '010-2356-3936', 'USER', '46234', '부산 금정구 금샘로485번길 65', '학생기숙사', NULL, '2024-09-20 15:44:41', NULL);
